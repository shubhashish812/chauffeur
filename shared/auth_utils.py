...
class AuthUtils:
    ...
    @staticmethod
    def create_user_response(user_record: auth.UserRecord, token: str, 
                           provider: Optional[str] = None, 
                           provider_uid: Optional[str] = None) -> Dict[str, Any]:
    ...
    @staticmethod
    def generate_audit_log(action: str, user_uid: str, details: Dict[str, Any]) -> Dict[str, Any]:

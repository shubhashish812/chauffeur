...
from Config.models import SignupData, SigninData, ResetPasswordData, ChangePasswordData
...
class BasicAuthInterface(BaseAuthInterface):
    ...
    def signin(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if not user_record.email_verified:
                raise ValueError("Email verification required. Please check your email and click the verification link.")
    ...
    def change_password(self) -> Dict[str, Any]:
        ...
        try:
            ...
            firebase_client.update_user(change_data.uid, password=change_data.new_password)
    ...
    def get_auth_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "supported_actions": ["signup", "signin", "signout", "reset_password", "change_password"]
        }
